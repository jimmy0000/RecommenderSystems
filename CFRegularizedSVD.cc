...
//TODO: Uncomment this
VI item2userrating[1];//MAX_NUMBER_OF_ITEMS];
...
double userfeaturematrix[MAX_NUMBER_OF_USERS][MAX_NUMBER_OF_FEATURES];
double itemfeaturematrix[MAX_NUMBER_OF_ITEMS][MAX_NUMBER_OF_FEATURES];

//TODO: Uncomment this
double itemitemsimilarityscores[1][1];//[MAX_NUMBER_OF_ITEMS][MAX_NUMBER_OF_ITEMS]; //5000 * 5000 * 8 = 200 MB
...
void ComputeItemItemSimilarities(double (*SimilarityMetric)(int itemidA, int itemidB) = Similarity_Pearson_NormWeighted)
{
  ...
  REP(itemid, numitems)
  {
    ...
    {
      double similarity = (*SimilarityMetric)(itemid, itemid2);
...
void DoRegularizedSVD(double regularizationConstant, int numLatentFactors)
{
  ...
  {    
    ...
    // cout<<"Iteration:"<<iteration<<" RMSE Error:"<<error<<" Time taken for validation: "<<(double)(clock() - validationstart)/(double)CLOCKS_PER_SEC<<" seconds"<<endl;
...
int main()
{
  ...
  LoadTrainingData("F:\\track1\\rec_log_train_deduped_mapped_train_correct2.txt", "\t");
  //LoadValidationData("F:\\track1\\rec_log_train_deduped_mapped_validation_correct2.txt", "\t");
  LoadTestingData("F:\\track1\\rec_log_test_deduped_mapped2.txt", "\t");
  ...
  AppendRSVDValuesToDataset("F:\\track1\\rec_log_train_deduped_mapped_train_correct2.txt", "\t");
  AppendRSVDValuesToDataset("F:\\track1\\rec_log_train_deduped_mapped_validation_correct2.txt", "\t");
  AppendRSVDValuesToDataset("F:\\track1\\rec_log_test_deduped_mapped2.txt", "\t");
