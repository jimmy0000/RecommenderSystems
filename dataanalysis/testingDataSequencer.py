...
f = open('rec_log_test_private_result_sorted.txt')
fw = open('rec_log_test_private_result_sorted_mapped.txt', 'w')
prevuserid = -1
previtemid = -1
lineno = 0
for line in f:
...
f = open('rec_log_test_public_result_sorted.txt')
fw = open('rec_log_test_public_result_sorted_mapped.txt', 'w')
prevuserid = -1
previtemid = -1
lineno = 0
for line in f:
