...
const string OUTPUT_FILE = "F:\\track1\\output_logistic_regression.txt";
const string USER_FEATURES_FILE = "F:\\track1\\userfeatures_mapped.txt";
const string ITEM_FEATURES_FILE = "F:\\track1\\itemfeatures_mapped.txt";
