...
void ComputePageRank(double s = 0.85, double tolerance = 0.0001,int MAXIMUM_ITERATIONS = 150)
{
  ...
  REP(iteration, MAXIMUM_ITERATIONS)
  {
    ...
    double additionalPageRankTerm = s * innerproduct / (double)numusers + (1.0 - s) / (double)numusers;
...
int main()
{
  ...
  LoadSocialNetwork("/home/arvind/track1/weighteddirgraph_mapped_retweet_sorted_bfsdepth2_directed.txt");
  
  ComputePageRank();

  OutputPageRank("/home/arvind/track1/user_mapped_pagerank_retweet_bfsdepth2.txt");
