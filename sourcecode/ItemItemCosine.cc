...
void OutputFeaturesToFile(string file, VI *v)
{
  ...
  REP(userid, numusers)
  {
    ...
    REP(itemIndex, numItemsForUser)
    {
      ...
      fout<<userid<<" "<<itemid<<" "<<cosine_similarity<<endl;//" "<<pearson_similarity<<endl;
      lineno++;
...
int main()
{
  ...
  cout<<"output"<<endl;
  OutputFeaturesToFile("/home/arvind/track1/feature_itemitemcosinesimilarity_train.txt", user2itemrating);
  OutputFeaturesToFile("/home/arvind/track1/feature_itemitemcosinesimilarity_validation.txt", validationuser2itemrating);
  OutputFeaturesToFile("/home/arvind/track1/feature_itemitemcosinesimilarity_publictest.txt", publictestuser2itemrating);
  OutputFeaturesToFile("/home/arvind/track1/feature_itemitemcosinesimilarity_privatetest.txt", privatetestuser2itemrating);
